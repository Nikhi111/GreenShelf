...
@Tag(name = "Admin Management", description = "Admin operations for managing sellers and nurseries")
@Validated
...
public class AdminController {
        ...
        @Operation(summary = "Register a new admin", description = "Creates a new admin account in the system")
        @ApiResponses(value = {
        ...
        public ResponseEntity<Map<String, String>> verifyNursery(
                        ...
                        @PathVariable @Parameter(description = "ID of the nursery to verify") int nurseryId) {
